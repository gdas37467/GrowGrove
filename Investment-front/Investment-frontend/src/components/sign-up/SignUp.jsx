...
function SignUp() {
  ...
  else if (signupData.firstName.length < 3)
  ...
  else if (signupData.lastName.length < 3)
  ...
  else if (signupData.username.length > 25)
    newErrors.username = 'Username must be at most 25 characters';
  else if (signupData.username.includes(' ')) {
      ...
      <div className="flex mt-10">
        ...
        <div className="mt-5 md:mt-2 mb-5 md:mb-10 ml-2 md:ml-5">
          ...
          <div className="mt-5 md:mx-0 mx-8 flex flex-col">
              ...
              />
              {errors.username && <div className="error text-red-500">{errors.username}</div>}
            </div>
            <div className="mt-5 md:mx-0 mx-8 flex flex-col">
